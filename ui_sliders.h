...
**
** Created: Wed Apr 2 14:42:45 2014
...
public:
    ...
    void setupUi(QWidget *sliders)
    {
        ...
        layoutWidget = new QWidget(sliders);
        layoutWidget->setObjectName(QString::fromUtf8("layoutWidget"));
        layoutWidget->setGeometry(QRect(10, 10, 1001, 218));
        ...
        mySlider_X_min = new QSlider(layoutWidget);
        ...
        mySlider_X_max = new QSlider(layoutWidget);
        ...
        x_min_val = new QLabel(layoutWidget);
        ...
        x_max_val = new QLabel(layoutWidget);
        ...
        mySlider_Y_min = new QSlider(layoutWidget);
        ...
        mySlider_Y_max = new QSlider(layoutWidget);
        ...
        y_min_val = new QLabel(layoutWidget);
        ...
        y_max_val = new QLabel(layoutWidget);
        ...
        mySlider_Z_min = new QSlider(layoutWidget);
        ...
        mySlider_Z_max = new QSlider(layoutWidget);
        ...
        z_min_val = new QLabel(layoutWidget);
        ...
        z_max_val = new QLabel(layoutWidget);
    ...
    {
        sliders->setWindowTitle(QApplication::translate("sliders", "Limits", 0, QApplication::UnicodeUTF8));
